 ...
 */
public class AttributeExtensions extends AbstractAttribute {

	// TODO: Currently doesn't handle list attributes that span multiple lines.
	 ...
	 */
	public AttributeExtensions(String value) {
		this.value = value;
